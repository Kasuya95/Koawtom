    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12"> <br>
                ...
                <a href="addfood.php" class="btn btn-light">+เพิ่มอาหาร</a>
                <a href="addmin.php" class="btn btn-info float-end">กลับหน้าแรก</a>
                </h3> <br />
                <table id="PatientTable" class="display table table-striped  table-hover table-responsive table-bordered table-success table-striped">
                    ...
                    <tbody>
                        <?php
                        require 'connect.php';
                        $query = "SELECT * FROM food f,menu m WHERE m.Menu_ID = f.Menu_ID ";
                        ...
                        foreach ($result as $r) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="updateform.php?Food_ID=<?= $r['Food_ID'] ?>" class="btn btn-warning btn-sm">แก้ไข</a>
                                </td>
                                <td>
                                    <a href="delete.php?Food_ID=<?= $r['Food_ID'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a>
                                </td>
